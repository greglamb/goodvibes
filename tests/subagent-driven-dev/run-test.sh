...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/goodvibes
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/goodvibes-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using goodvibes:subagent-driven-development. The plan is at: $PLAN_PATH"
