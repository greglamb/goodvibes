...
> **For agentic workers:** REQUIRED: Use goodvibes:subagent-driven-development (if subagents available) or goodvibes:executing-plans to implement this plan.
...
**Spec:** docs/goodvibes/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/goodvibes/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use goodvibes:subagent-driven-development (if subagents available) or goodvibes:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
